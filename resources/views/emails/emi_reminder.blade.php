    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="remind-text">
                Your monthly installment for your <strong>{{ $emi->loanDetail->provider }}</strong> loan is due soon. Maintaining timely payments helps keep your credit score healthy!
            </div>
